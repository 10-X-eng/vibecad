...
class SMWorkbench(Workbench):
    ...
    def Initialize(self):
        ...
        import SheetMetalSourceCreationGui
        SheetMetalSourceCreationGui.ensure_commands_registered()
        import SheetMetalRMFGGui
        SheetMetalRMFGGui.ensure_commands_registered()
        import SheetMetalRMFGManufacturingGui
        SheetMetalRMFGManufacturingGui.ensure_commands_registered()
