...
from vibecad_tests.native_sketch_projection_gui_case import (
...
def _phase(name: str) -> None:
    os.write(2, f"VIBECAD_NATIVE_SKETCH_PROJECTION_PHASE {name}\n".encode("ascii"))
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = Path(tempfile.mkdtemp(prefix="vibecad-native-projection-")) / (
        ...
        _phase("complete")
        print(
            "VIBECAD_NATIVE_SKETCH_PROJECTION_GUI_OK "
