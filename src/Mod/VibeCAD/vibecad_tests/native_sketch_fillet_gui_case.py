...
"""Fillet case for the rolling Native Sketch GUI lifecycle gate."""
...
def _prepare_fixtures(document: Any, sketch: Any) -> None:
    ...
    document.openTransaction("Prepare Native Sketch Fillet fixtures")
    try:
        assert (
            int(
                sketch.addGeometry(
...
def verify_reopened_fillet(sketch: Any, expected: dict[str, Any]) -> None:
