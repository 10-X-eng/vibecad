...
def _phase(name: str) -> None:
    os.write(2, f"VIBECAD_NATIVE_SKETCH_KNOT_MULTIPLICITY_PHASE {name}\n".encode())
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = Path(tempfile.mkdtemp(prefix="vibecad-native-knot-mult-")) / (
        ...
        _phase("complete")
        print(
            "VIBECAD_NATIVE_SKETCH_KNOT_MULTIPLICITY_GUI_OK "
