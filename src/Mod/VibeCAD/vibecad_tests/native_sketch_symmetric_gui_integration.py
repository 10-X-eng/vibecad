...
from vibecad_tests.native_sketch_symmetric_gui_case import (
...
def _run() -> None:
    ...
    try:
        ...
        process_events(16)
        save_path = (
            Path(tempfile.mkdtemp(prefix="vibecad-native-sketch-symmetric-"))
        ...
        print(
            "VIBECAD_NATIVE_SKETCH_SYMMETRIC_GUI_OK "
