...
"""Concise provider-safe failures for Native Analyze capabilities."""
...
class NativeAnalyzeError(NativeMutationError):
    def __init__(
        self,
        message: str,
        *,
        error_code: str = "NATIVE_ANALYZE_OPERATION_FAILED",
