...
This is the behavior-preserving extraction seam beneath NativeBackground. It is
intentionally ephemeral in this migration phase: no durable persistence, no
concurrency expansion, no provider routing, and no engineering-domain imports.
"""
...
class AnalysisRuntimeManager:
    ...
    The manager owns only generic lifecycle mechanics. Engineering preparation,
    dependency validation, document mutation, and qualification remain supplied
    by callers through explicit callbacks.
    """
