...
"""Concise provider-safe failures for Native Manufacture capabilities."""
...
class NativeManufactureError(NativeMutationError):
    def __init__(
        self,
        message: str,
        *,
        error_code: str = "NATIVE_MANUFACTURE_OPERATION_FAILED",
