...
def compare_domain_presentations(
    ...
    value = {
        **_inert("domain_presentation_comparison"),
        ...
        "provenance": {
            "baseline": {
                "analysis_owners": baseline_extension.get("analysis_owners") or [],
                "post_pipeline_owners": baseline_extension.get("post_pipeline_owners") or [],
                "timeline_owner_chain": baseline_extension.get("timeline_owner_chain") or [],
                "mesh_object_name": baseline_extension.get("mesh_object_name"),
                "point_count": baseline_extension.get("point_count"),
                "cell_count": baseline_extension.get("cell_count"),
            },
            "candidate": {
                "analysis_owners": candidate_extension.get("analysis_owners") or [],
                "post_pipeline_owners": candidate_extension.get("post_pipeline_owners") or [],
                "timeline_owner_chain": candidate_extension.get("timeline_owner_chain") or [],
                "mesh_object_name": candidate_extension.get("mesh_object_name"),
                "point_count": candidate_extension.get("point_count"),
                "cell_count": candidate_extension.get("cell_count"),
            },
        },
