...
"""Closed exact target for one-step B-spline knot multiplicity decrease."""
...
LABEL = "Decrease Knot Multiplicity"
...
class SketchBSplineKnotMultiplicityDecreaseSpec:
